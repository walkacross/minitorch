...
inline std::ostream& operator<<(
        ...
        switch (memory_format) {
            ...
            default:
                std::cout << "Unknown memory format " << memory_format << std::endl;
        }
}
    ...
    inline std::vector<T> get_channels_last_strides_2d(ArrayRef<T> sizes) {
        ...
        switch (sizes.size()) {
            ...
            case 3:
                ...
                return strides;
            default:
                std::cout << "ChannelsLast2d doesn't support size " << sizes.size() << std::endl;
        }
    }
    ...
    std::vector<T> get_channels_last_strides_3d(ArrayRef<T> sizes) {
        ...
        switch (sizes.size()) {
            ...
            case 4:
                ...
                return strides;
            default:
                std::cout << "ChannelsLast3d doesn't support size " << sizes.size() << std::endl;
        }
    }
